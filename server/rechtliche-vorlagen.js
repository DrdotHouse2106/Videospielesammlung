...
- Kostenpflichtige Zusatzleistungen für Händler (Händler-Pakete mit mehr Angeboten, Zusatzpaket API-Anbindung an Shop oder Warenwirtschaft) richten sich ausschließlich an Unternehmer. Sie werden monatlich im Voraus abgerechnet (Stripe: Karte oder SEPA-Lastschrift; PayPal zzgl. Zahlungsgebühr; auf Rechnung zahlbar innerhalb von 7 Tagen – bei Zahlungsverzug kann der Zugang bis zum Zahlungseingang pausiert werden), verlängern sich jeweils um einen Monat und sind jederzeit zum Ende des bezahlten Monats kündbar. Die Rechnung wird elektronisch bereitgestellt. Individuelle Anbindungen und größere Kontingente werden gesondert vereinbart. [Preise, Leistungsumfang und ggf. Verfügbarkeit ergänzen.]
